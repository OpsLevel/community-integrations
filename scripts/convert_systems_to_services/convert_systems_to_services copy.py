...
OL_SYSTEM_MUTATION = """
mutation create_system($alias:String, $description:String, $ownerId:ID, $parentId: ID, $note:String){
  systemCreate(input:{name:$alias, description:$description, ownerId: $ownerId, parent:{id:parentId}, note:$note){
    system{
      id
      name
      aliases
