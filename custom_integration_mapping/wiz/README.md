...
**Most accounts need neither.** OpsLevel ships a [first-class Wiz
integration](https://docs.opslevel.com/docs/wiz-integration) — add it from
...
for the cases it doesn't cover.
...
The pull example is the closer match to the built-in integration: it reuses the
